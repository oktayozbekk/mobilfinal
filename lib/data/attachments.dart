...
List getAttachmentListForAnnouncement(title) {
  ...
  list1.forEach((element) {
    var attachment = getAttachment(element.url);
    if (attachment != null) {
...
// makes list of Attachment only for a specific Ogrenci
