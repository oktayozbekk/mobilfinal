...
class AttachmentsDB {
  CollectionReference attachmentReference = FirebaseFirestore.instance.collection("Ekler");
  ...
  // function to add Ekler in class in database
  ...
  // function to add Attachment to Ogrenci
  ...
  // function to make list of Ekler from DB
