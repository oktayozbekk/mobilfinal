...
import 'package:oktay/utils/datetime.dart';
import 'package:datetime_picker_formfield/datetime_picker_formfield.dart';
import 'package:intl/intl.dart';
import 'package:oktay/widgets/attachment_editor_composer.dart';
              ...
              child: Column(
                children: [
                  ...
                  DropdownButtonFormField(
                    decoration: InputDecoration(labelText: "Tür", border: OutlineInputBorder()),
                    value: type,
                    onChanged: (newValue) {
                      setState(() {
                    ...
                    items: ['Bildiri', 'Odev'].map((location) {
                  ...
                  if(type == 'Odev') SizedBox(height: 20.0),

                  if(type == 'Odev') DateTimeField(
