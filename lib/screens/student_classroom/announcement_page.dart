...
import 'package:oktay/widgets/submit_composer.dart';
      ...
      body: ListView(
          children: [
            ...
            if(widget.announcement.type == 'Odev') Container(
              ...
              child: Text(
                "Bitiş " + widget.announcement.dueDate,
                style: TextStyle(
            ...
            widget.announcement.type == "Odev" ? SubmissionComposer(widget.announcement, widget.announcement.classroom.uiColor) : Container()
            //Ekler(widget.announcement.attachments)
          ]
      )
    );
  }
