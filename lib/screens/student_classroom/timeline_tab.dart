...
import 'package:oktay/screens/student_classroom/announcement_page.dart';
...
class _TimelineTabState extends State<TimelineTab> {
  ...
  Widget build(BuildContext context) {
    ...
    List classWorkList = announcementList.where((i) => i.type == "Odev" && i.classroom.students.contains(account)).toList();
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          "Bitiş " + classWorkList[index].dueDate,
                          style: TextStyle(color: Colors.grey),
                        ),
                      ),
                    ],
